...
<!-- coverage:begin -->
The following results were measured on 2026-07-22 with disposable etcd, PostgreSQL, and Kafka containers, all three `TEST_*` variables set, and the REST smoke suite's instrumented controller binary included:

| Package | Coverage |
|---|---:|
| `internal/utils` | 100.0% |
| `internal/validation` | 100.0% |
| `internal/storage` | 88.6% |
| `internal/db` | 80.3% |
| `internal/kafka` | 76.7% |
